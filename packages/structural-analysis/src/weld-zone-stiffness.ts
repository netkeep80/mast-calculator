import { calculateWeldServiceDegradation } from '../../domain/index.js'

export const DEFAULT_WELD_AFFECTED_ZONE_LENGTH_FACTOR = 4
export const MINIMUM_WELD_AFFECTED_ZONE_LENGTH_MM = 25

export interface EquivalentMemberWeldZoneStiffnessInput {
  readonly memberLengthM?: number
  readonly memberDiameterMm?: number
  readonly weldAffectedZoneLengthFactor?: number
  readonly serviceYears?: number
  readonly initialStiffnessRetention?: number
  readonly annualStiffnessLossRate?: number
  readonly minimumStiffnessRetention?: number
}
...
}: EquivalentMemberWeldZoneStiffnessInput = {}) {
