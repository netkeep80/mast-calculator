...
export const WIND_PRESET_OPTIONS = Object.freeze([
  Object.freeze({
...
export function windPressureFromSpeedMs(speedMs, airDensityKgM3 = AIR_DENSITY_KG_M3) {
...
export function windSpeedFromPressurePa(pressurePa, airDensityKgM3 = AIR_DENSITY_KG_M3) {
...
export function resolveWindParameters(parameters) {
