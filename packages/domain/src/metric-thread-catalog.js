...
export const METRIC_COARSE_THREADS = Object.freeze([
...
].map(([diameterMm, pitchMm]) => Object.freeze({
  diameterMm,
  pitchMm,
...
export function getMetricCoarseThread(diameterMm) {
...
export function metricThreadStressAreaMm2(diameterMm, pitchMm = null) {
